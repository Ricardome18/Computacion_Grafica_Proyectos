//Actividad Animación por Keyframes		Mendoza Espinosa Ricardo
//Fecha de entrega : 27 - 04 - 2025    	 	319018370
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Actividad Animacion 3 -Ricardo Mendoza ", nullptr, nullptr);
